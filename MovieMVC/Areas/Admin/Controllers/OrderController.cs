    ...
    public class OrderController : Controller
    {
        ...
        public IActionResult Details(int id)
        {
            OrderVM = new OrderDetailsVM()
            {
                ...
                OrderDetails = _unitOfWork.OrderDetails.GetAll(o => o.OrderId == id, includeProperties: "Movie")
            };
            return View(OrderVM);
        }
        ...
        public IActionResult GetOrderList(string status)
        {
            ...
            {
                orderHeaderList = _unitOfWork.OrderHeader.GetAll(o=>o.ApplicationUserId==claim.Value,includeProperties:"ApplicationUser");
            }
            ...
            switch (status)
            {
                case "pending":
                    ...
                    break;
                case "rejected":
                    orderHeaderList = orderHeaderList.Where(o => o.OrderStatus == SD.StatusRefunded || o.OrderStatus == SD.StatusInProcess || o.OrderStatus == SD.PaymentStatusRejected);
                    break;
                case "completed":
